...
; NAME
;>1 blk
;  blk_freplace - replace first match in buffer
...
;;  mov	ebp,[buf_end]
  call	blk_fdel_bytes		;remove match string
;
...
; NAME
;>1 blk
;  blk_freplace_all - replace all matches in buffer
...
bra_again:
  ...
  call	br_fentry		;go do another replace
