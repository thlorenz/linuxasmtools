...
;----------------------------------------------------------------------------------------
;>1 widget
; select_1up_list_left - display selection list on left half of screen
;
...
;<
;-------------------------------------------------------------------------             
  global select_1up_list_left
select_1up_list_left:
  mov	al,1
...
; now begin filling in the structure
  ...
  jne	sll_10					;jmp if even number of columns
  inc	al
sll_10:
  shr	al,1
  mov	byte [ebp+sl.win_columns],al		;use right half of screen
;  inc	al					;convert to 1 based location
  mov	byte [ebp+sl.win_left_column],2		;put window at left edge
